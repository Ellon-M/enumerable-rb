...
# 📖 Own Enum <a name="about-project"></a>

**Enumerable** is a module that implements some of the methods of the [Enumerable](https://ruby-doc.org/core-3.0.0/Enumerable.html) in ruby language.
...
```sh
  cd my-folder
  git clone  https://github.com/Ellon-M/enumerable-rb.git
```

### Usage

To view the project, open the file `my_enum.rb`.
